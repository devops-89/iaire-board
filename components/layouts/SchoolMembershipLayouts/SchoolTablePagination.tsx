...
interface SchoolTablePaginationProps {
  currentPage: number;
  totalPages: number;
  totalSchools: number;
  indexOfFirstSchool: number;
  indexOfLastSchool: number;
  onPrevPage: () => void;
  onNextPage: () => void;
  onPageChange: (page: number) => void;
}

export const SchoolTablePagination: React.FC<SchoolTablePaginationProps> = ({
  currentPage,
  totalPages,
  totalSchools,
  indexOfFirstSchool,
