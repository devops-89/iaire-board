...
export const InnovationResearchLayout = () => {
  const [activeTab, setActiveTab] = useState<"innovations" | "research">("innovations");
      ...
      >
        ...
        >
          ...
          >
            ...
            <Box
              sx={{
                ...
                transform: activeTab === "innovations" ? "translateX(0)" : "translateX(100%)",
            ...
            <Button
              ...
              sx={{
                flex: 1,
                color: activeTab === "innovations" ? "#fff" : "rgba(18, 35, 51, 0.6)",
                bgcolor: "transparent",
                fontWeight: 700,
                borderRadius: "10px",
                py: 1,
                ...
                "&:hover": {
                  bgcolor: "transparent",
                  color: activeTab === "innovations" ? "#fff" : Colors.PRIMARY_DARK,
                },
              }}
            >
              Innovations
            ...
            <Button
              ...
              sx={{
                flex: 1,
                color: activeTab === "research" ? "#fff" : "rgba(18, 35, 51, 0.6)",
                bgcolor: "transparent",
                fontWeight: 700,
                borderRadius: "10px",
                py: 1,
                ...
                "&:hover": {
                  bgcolor: "transparent",
                  color: activeTab === "research" ? "#fff" : Colors.PRIMARY_DARK,
                },
              }}
            >
              Research
          ...
          >
            ...
            />
            <InputBase
              placeholder={activeTab === "innovations" ? "Search innovations..." : "Search research papers..."}
              value={searchQuery}
